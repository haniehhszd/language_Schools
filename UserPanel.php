...
if (isset($_POST['register'])) {
    ...
    // insert into database and table registration
            ...
            <div class="image_profile">
                <form action="" id="form" enctype="multipart/form-data" method="post">
                    <div class="upload">
                        ...
                        $ima3ge = $user_data['image'];
                        ?>
                        <img src="./assets/images/<?php echo $image; ?>" style=" width: 125px; height: 125px" ;title="<?php echo $image; ?>" alt="عکس موجود نیست">
                        <div class="round">
...
<td>
<!--define a tag for make icons edit and delete buttons-->
...
<!-- for open file that choose images -->
    <script>
